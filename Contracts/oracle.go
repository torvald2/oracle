...
func (_Oracle *OracleCaller) SLastError(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _Oracle.contract.Call(opts, &out, "s_lastError")
...
//
// Solidity: function s_lastError() view returns(bytes)
func (_Oracle *OracleSession) SLastError() ([]byte, error) {
	return _Oracle.Contract.SLastError(&_Oracle.CallOpts)
}

// SLastError is a free data retrieval call binding the contract method 0x4b0795a8.
//
// Solidity: function s_lastError() view returns(bytes)
func (_Oracle *OracleCallerSession) SLastError() ([]byte, error) {
	return _Oracle.Contract.SLastError(&_Oracle.CallOpts)
}
...
func (_Oracle *OracleCaller) SLastRequestId(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Oracle.contract.Call(opts, &out, "s_lastRequestId")
...
//
// Solidity: function s_lastRequestId() view returns(bytes32)
func (_Oracle *OracleSession) SLastRequestId() ([32]byte, error) {
	return _Oracle.Contract.SLastRequestId(&_Oracle.CallOpts)
}

// SLastRequestId is a free data retrieval call binding the contract method 0xb1e21749.
//
// Solidity: function s_lastRequestId() view returns(bytes32)
func (_Oracle *OracleCallerSession) SLastRequestId() ([32]byte, error) {
	return _Oracle.Contract.SLastRequestId(&_Oracle.CallOpts)
}
...
func (_Oracle *OracleCaller) SLastResponse(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _Oracle.contract.Call(opts, &out, "s_lastResponse")
...
//
// Solidity: function s_lastResponse() view returns(bytes)
func (_Oracle *OracleSession) SLastResponse() ([]byte, error) {
	return _Oracle.Contract.SLastResponse(&_Oracle.CallOpts)
}

// SLastResponse is a free data retrieval call binding the contract method 0x3944ea3a.
//
// Solidity: function s_lastResponse() view returns(bytes)
func (_Oracle *OracleCallerSession) SLastResponse() ([]byte, error) {
	return _Oracle.Contract.SLastResponse(&_Oracle.CallOpts)
}
...
//
// Solidity: function sendRequest(uint64 subscriptionId, string[] args) returns(bytes32)
func (_Oracle *OracleTransactor) SendRequest(opts *bind.TransactOpts, subscriptionId uint64, args []string) (*types.Transaction, error) {
	return _Oracle.contract.Transact(opts, "sendRequest", subscriptionId, args)
}

// SendRequest is a paid mutator transaction binding the contract method 0x48a7d26d.
//
// Solidity: function sendRequest(uint64 subscriptionId, string[] args) returns(bytes32)
func (_Oracle *OracleSession) SendRequest(subscriptionId uint64, args []string) (*types.Transaction, error) {
	return _Oracle.Contract.SendRequest(&_Oracle.TransactOpts, subscriptionId, args)
}

// SendRequest is a paid mutator transaction binding the contract method 0x48a7d26d.
//
// Solidity: function sendRequest(uint64 subscriptionId, string[] args) returns(bytes32)
func (_Oracle *OracleTransactorSession) SendRequest(subscriptionId uint64, args []string) (*types.Transaction, error) {
	return _Oracle.Contract.SendRequest(&_Oracle.TransactOpts, subscriptionId, args)
}
...
// FilterResponse is a free log retrieval operation binding the contract event 0x160ed0aaffbef6885155188b91459cb5a97d5daadccf7561d8c46deea6641b50.
//
// Solidity: event Response(bytes32 indexed requestId, string result, bytes response, bytes err)
func (_Oracle *OracleFilterer) FilterResponse(opts *bind.FilterOpts, requestId [][32]byte) (*OracleResponseIterator, error) {
	...
	logs, sub, err := _Oracle.contract.FilterLogs(opts, "Response", requestIdRule)
	if err != nil {
		return nil, err
	}
...
// WatchResponse is a free log subscription operation binding the contract event 0x160ed0aaffbef6885155188b91459cb5a97d5daadccf7561d8c46deea6641b50.
//
// Solidity: event Response(bytes32 indexed requestId, string result, bytes response, bytes err)
func (_Oracle *OracleFilterer) WatchResponse(opts *bind.WatchOpts, sink chan<- *OracleResponse, requestId [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Oracle.contract.WatchLogs(opts, "Response", requestIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseResponse is a log parse operation binding the contract event 0x160ed0aaffbef6885155188b91459cb5a97d5daadccf7561d8c46deea6641b50.
//
// Solidity: event Response(bytes32 indexed requestId, string result, bytes response, bytes err)
